...
def binary_classifer_config(classification_dataset: str, test_set_selection: str, label_column: str, 
    ...
    for chosen_learning_rate in learning_rate_choices:
        for dataset in classification_datasets:
            ...
            checkpoint_path, patience_value = prepare_and_clean_data(dataset, learning_rate_choices, chosen_learning_rate, 
