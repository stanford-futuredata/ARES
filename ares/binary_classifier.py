...
from .LLM_as_a_Judge_Adaptation.Late_Chunking_Classifier import binary_classifier_config_late_chunking
...
def binary_classifer_config(
    ...
    if use_late_chunking:
        binary_classifier_config_late_chunking(
            training_dataset,
            validation_set,
            label_column,
            num_epochs,
        ...
        for label in label_column:
            ...
            train_df, test_set = transform_data(synth_queries, validation_dataset_path, label, use_late_chunking)
            ...
            total_predictions, total_references, metric = evaluate_model(model, model_choice, checkpoint_path, device, eval_dataloader, inference_times, use_late_chunking)
