...
##############################CUSTOM MODELS (NOT OPENAI)######################################
            
def few_shot_context_relevance_scoring_local(system_prompt: str, query: str, document: str, model_choice, few_shot_examples=None):
    TOGETHER_API_KEY = os.getenv("TOGETHER_API_KEY")

    if not TOGETHER_API_KEY:
        print("TOGETHER_API_KEY environment variable not set. Please set the variable.")
        return -1
...
def few_shot_answer_faithfulness_scoring_local(system_prompt: str, query: str, document: str, answer: str, model_choice, few_shot_examples=None):
    TOGETHER_API_KEY = os.getenv("TOGETHER_API_KEY")
...
def few_shot_answer_relevance_scoring_local(system_prompt: str, query: str, document: str, answer: str, model_choice, few_shot_examples=None):
    TOGETHER_API_KEY = os.getenv("TOGETHER_API_KEY")
