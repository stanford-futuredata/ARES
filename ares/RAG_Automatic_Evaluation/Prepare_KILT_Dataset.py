...
dataset_choices = ["hotpotqa"] #"nq", "hotpotqa", "wow", "fever", 
...
for dataset_chosen in dataset_choices:
    ...
    kilt_dataset_total = load_dataset("kilt_tasks", name="hotpotqa")
        ...
        for split in ['validation']:   
            ...
            if split in ["validation"] and dataset_chosen in ["nq", "hotpotqa", "wow", "fever"]:
                ...
                for ratio in positive_negative_ratios:
                    ...
                    file_path = folder_path + "ratio_" + str(ratio) + "_reformatted_full_articles_" + str(gather_full_wikipedia_articles) + "_" + split + "_with_negatives.tsv"
