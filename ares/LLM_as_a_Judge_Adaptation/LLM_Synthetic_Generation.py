...
def generate_synthetic_query_api_approach(document: str, synthetic_query_prompt: str, prompt: str, length_of_fewshot_prompt: int, 
    ...
    Args:
        ...
        api_key (str): The API key for authenticating with the Together API.
    ...
    if prompt_tokens_length + document_length + 100 >= 4096:
        truncated_document = document[:4096 - prompt_tokens_length - 100]
